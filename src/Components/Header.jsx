...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 w-screen">
      <nav aria-label="Global" className="mx-auto flex -mt-9 max-w-7xl items-center justify-between p-6">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold text-gray-300">
              Services
